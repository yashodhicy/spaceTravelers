...
> This is the Space Travelers App, built using React and Redux for Microverse. It enables users to reserve and join space missions, providing a range of features through API calls.
...
- [[Live Demo Link](https://drive.google.com/file/d/1pi8_3ILIzyZinCli-qhZ83EFn8xgBDup/view?usp=sharing)]
...
```sh
  cd my-folder
  git clone https://github.com/yashodhicy/spaceTravelers
```
-
...
Feel free to check the [issues page](https://github.com/yashodhicy/spaceTravelers/issues).
